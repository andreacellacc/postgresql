...
WINNER_GOALS_SUM="$($PSQL "SELECT SUM(winner_goals) FROM games")"
OPPONENT_GOALS_SUM="$($PSQL "SELECT SUM(opponent_goals) FROM games")"
GOALS_SUM=$(( $WINNER_GOALS_SUM + $OPPONENT_GOALS_SUM ))
echo $GOALS_SUM
